...
**Note:** This guide was adapted from NPR Apps, and these best practices reference the [app-template](http://github.com/nprapps/app-template) in several places and generally assume you are using it.
